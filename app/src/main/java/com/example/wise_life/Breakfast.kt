...
class Breakfast : AppCompatActivity(), MenuAdapter.MenuClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Generate Diet Plan Card (3 items)
        menuPlanRecycler()
    ...
    override fun onResume() {
        ...
        if (sessionOut) {
            mAuth.signOut()
            Toast.makeText(this@Breakfast, "Session Timed Out!!.", Toast.LENGTH_LONG).show()
            startActivity(Intent(this@Breakfast, MainActivity::class.java))
        }
    }
    ...
    private fun menuPlanRecycler() {
        ...
        menu.add(MenuHelperClass(R.drawable.salmon, "Salmon", "208", "0", "20", "13"))
    ...
    override fun onMenuAddClicked(menu: MenuHelperClass) {
        ...
        val homePageIntent = Intent(this@Breakfast, HomePage::class.java)
