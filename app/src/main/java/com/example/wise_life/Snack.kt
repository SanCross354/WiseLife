...
class Snack : AppCompatActivity(), MenuAdapter.MenuClickListener {
    ...
    override fun onResume() {
        ...
        if (sessionOut) {
            mAuth.signOut()
            Toast.makeText(this@Snack, "Session Timed Out!!.", Toast.LENGTH_LONG).show()
            startActivity(Intent(this@Snack, MainActivity::class.java))
        }
    }
    ...
    private fun menuPlanRecycler() {
        ...
        menu.add(MenuHelperClass(R.drawable.banana, "Banana", "89", "22", "1", "0"))
        menu.add(MenuHelperClass(R.drawable.mixed_nuts, "Mixed Nuts", "200", "8", "5", "15"))
        menu.add(MenuHelperClass(R.drawable.greek_yogurt, "Greek Yogurt", "150", "10", "15", "5"))
        menu.add(MenuHelperClass(R.drawable.popcorn, "Popcorn", "30", "6", "1", "0"))
    ...
    override fun onMenuAddClicked(menu: MenuHelperClass) {
        ...
        val homePageIntent = Intent(this@Snack, HomePage::class.java)
