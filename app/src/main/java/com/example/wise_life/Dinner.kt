...
class Dinner : AppCompatActivity(), MenuAdapter.MenuClickListener {
    ...
    override fun onResume() {
        ...
        if (sessionOut) {
            mAuth.signOut()
            Toast.makeText(this@Dinner, "Session Timed Out!!.", Toast.LENGTH_LONG).show()
            startActivity(Intent(this@Dinner, MainActivity::class.java))
        }
    }
    ...
    private fun menuPlanRecycler() {
        ...
        menu.add(MenuHelperClass(R.drawable.salmon, "Grilled Salmon", "208", "0", "20", "13"))
        menu.add(MenuHelperClass(R.drawable.spaghetti_bolognese, "Spaghetti Bolognese", "450", "80", "15", "10"))
        menu.add(MenuHelperClass(R.drawable.ribeye_steak, "Ribeye Steak", "500", "0", "25", "40"))
        menu.add(MenuHelperClass(R.drawable.chicken_curry, "Chicken Curry", "300", "20", "15", "18"))
    ...
    override fun onMenuAddClicked(menu: MenuHelperClass) {
        ...
        val homePageIntent = Intent(this@Dinner, HomePage::class.java)
